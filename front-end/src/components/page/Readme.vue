    ...
    <div>
        <div class="crumbs">
            <el-breadcrumb separator="/">
                <el-breadcrumb-item><i class="el-icon-setting"></i>项目说明</el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <div class="ms-doc">
            <h3>项目说明</h3>
            <article>
                <h1>manage-system</h1>
                <p>基于Vue.js 2.x系列 + Element UI + axios的后台管理系统解决方案</p>
                <h2>前言</h2>
                <p>之前在公司用了Vue + Element组件库 + axios 做了个后台管理系统，基本很多组件可以直接引用组件库的，但是也有一些需求无法满足。像图片裁剪上传、富文本编辑器、图表等这些在后台管理系统中很常见的功能，就需要引用其他的组件才能完成。从寻找组件，到使用组件的过程中，遇到了很多问题，也积累了宝贵的经验。所以我就把开发这个后台管理系统的经验，总结成这个后台管理系统解决方案。</p>
...
<!--                <el-checkbox disabled checked>支持切换主题色</el-checkbox>-->
                <br>
                <el-checkbox disabled checked>axios 跨域</el-checkbox>
                <br>
            </article>
        </div>
